...
class AvatarsController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('frontend.avatars.index', compact('avatars'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.avatars.create', compact('projects'));
    }
    ...
    public function store(StoreAvatarRequest $request)
    {
        ...
        return redirect()->route('frontend.avatars.index');
    }
    ...
    public function edit(Avatar $avatar)
    {
        ...
        return view('frontend.avatars.edit', compact('avatar', 'projects'));
    }
    ...
    public function show(Avatar $avatar)
    {
        ...
        return view('frontend.avatars.show', compact('avatar'));
    }
