    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.videos.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('video_code') ? 'is-invalid' : '' }}" type="text" name="video_code" id="video_code" value="{{ old('video_code', '') }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('video_url') ? 'is-invalid' : '' }}" name="video_url" id="video_url">{{ old('video_url') }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('minutes') ? 'is-invalid' : '' }}" type="text" name="minutes" id="minutes" value="{{ old('minutes', '') }}">
