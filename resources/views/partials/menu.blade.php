<div id="sidebar" class="c-sidebar c-sidebar-fixed c-sidebar-lg-show">
    ...
    <ul class="c-sidebar-nav">
        ...
        @can('avatar_access')
            <li class="c-sidebar-nav-item">
                <a href="{{ route("admin.avatars.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/avatars") || request()->is("admin/avatars/*") ? "c-active" : "" }}">
                    <i class="fa-fw fas fa-user-friends c-sidebar-nav-icon">

                    </i>
                    {{ trans('cruds.avatar.title') }}
                </a>
            </li>
        @endcan
        @can('audio_access')
            <li class="c-sidebar-nav-item">
                <a href="{{ route("admin.audios.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/audios") || request()->is("admin/audios/*") ? "c-active" : "" }}">
