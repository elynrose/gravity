                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.projects.update", [$project->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="prompt" id="prompt" required>{{ old('prompt', $project->prompt) }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="script" id="script" required>{{ old('script', $project->script) }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="status" id="status" value="{{ old('status', $project->status) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            @foreach(App\Models\Project::PRIVACY_RADIO as $key => $label)
                                <div>
                                    <input type="radio" id="privacy_{{ $key }}" name="privacy" value="{{ $key }}" {{ old('privacy', $project->privacy) === (string) $key ? 'checked' : '' }}>
